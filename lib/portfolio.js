...
<title>Our Work · ${esc(brand.name)}</title>
...
<header><div class="wrap nav">
  <a href="/" aria-label="${esc(brand.name)} home"><img src="${brand.logoPath}" alt="${esc(brand.name)}" class="brand-logo"></a>
  <div class="nav-r">
    <a class="home" href="/">← Home</a>
    <a class="btn" href="/#contact">Get a ${esc(brand.priceLabel)} site →</a>
  </div>
</div></header>
...
<section class="hero">
  ...
  <p>Real, modern websites for local businesses across ${esc(brand.region)}. Every one is a <b>live, clickable site</b> — tap any project to explore it. All for one flat price of <b>${esc(brand.priceLabel)}</b>.</p>
</section>
...
<footer>
  <div class="cta"><a class="btn" href="/#contact">Get my ${esc(brand.priceLabel)} website →</a></div>
  <div>© <span id="yr"></span> ${esc(brand.name)} · Proudly serving ${esc(brand.region)}</div>
</footer>
