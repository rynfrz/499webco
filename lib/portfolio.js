...
<title>Our Work · Websites For Locals</title>
...
<body>
  <section class="hero">
    <div class="eyebrow">Websites For Locals</div>
    <h1>Our Work</h1>
    <p class="sub">Modern, high-converting websites we've built for local businesses. Tap any project to explore it live.</p>
  </section>
  <div class="controls">
  ...
  <footer>Built with care by Websites For Locals</footer>
  <script>
    function fit(){
