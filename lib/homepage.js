  ...
  <div class="wrap">
    <div class="cta-band reveal">
      ...
      <div class="hero-cta" style="justify-content:center;margin-top:26px">
        <a href="mailto:hello@499web.co?subject=I want a $499 website" class="btn primary lg">Email us <span class="arrow">→</span></a>
        <a href="tel:+14046206517" class="btn ghost lg">Call (404) 620-6517</a>
      </div>
      <p style="margin-top:20px;color:var(--muted);font-size:13.5px">hello@499web.co · Proudly built in Gwinnett County, GA</p>
    </div>
  </div>
</section>
</main>
